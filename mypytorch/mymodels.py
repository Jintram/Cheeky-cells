...
class CNN(nn.Module):
    ...
    def __init__(self, input_size, num_classes):
        ...
        # adapted code MW
        remaining_size = int(  (((input_size[1] - 2)//2)-2)//2  )
...
def testsomestuff0():
    ...
    modelCNN2 = CNN((1, 28, 28),6).to("mps")
    X4 = torch.rand(64, 1, 28, 28, device="mps") # random image as test input
    logits = modelCNN2(X4) # "logits" refers to raw, unnormalized outputs of the final layer of a neural network
    

################################################################################
# A brutally simple model
