...
*Overview of annotation procedure. <b>Left</b> the original image, <b>>center</b> the human-generated annotation, and on the <b>right</b> training classes that were generated to train the model (this is optional and training can also be done directly on a human-annotated segmentation).*